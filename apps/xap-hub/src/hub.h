...
#define SETTINGS_FILE			"/etc/homected4pi/xap-hub.xml"			// Xml settings file
#define LOG_EVENTS_FILE			"/var/homected4pi/xap-hub_logevn.txt"	// Events log file
#define LOG_ERRORS_FILE			"/var/homected4pi/xap-hub_logerr.txt"	// Errors log file
